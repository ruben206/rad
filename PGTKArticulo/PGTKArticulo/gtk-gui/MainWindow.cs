...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.addAction = new global::Gtk.Action ("addAction", null, null, "gtk-new");
		...
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar'><toolitem name='addAction' action='addAction'/><toolitem name='editAction' action='editAction'/><toolitem name='deleteAction' action='deleteAction'/><toolitem name='refreshAction' action='refreshAction'/></toolbar></ui>");
